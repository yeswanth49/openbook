...
export const TypewriterEffect: React.FC<TypewriterProps> = ({
    ...
    return (
        <div className="transition-opacity duration-200">
            {displayedContent && <MarkdownRenderer content={preprocessLaTeX(displayedContent)} />}
            {!isComplete && (
                <motion.span
            ...
            <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                    <Image
                        ...
                        quality={100}
                    />
                    <h2 className="text-lg font-semibold font-syne text-neutral-800 dark:text-neutral-200">Neuman</h2>
                </div>
            </div>

            <TypewriterEffect content={content} speed={speed} onComplete={onComplete} />
        </div>
    );
};
