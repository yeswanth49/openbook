...
import { FrameworkSelector } from '@/components/features/study/framework-selector';
...
export function TerminalInput({
    ...
    const handleCommand = (command: string) => {
        ...
        switch (cmd) {
            ...
            case '/clear':
                ...
                break;
            case '/extreme':
                // Quick access to extreme mode - handle group selection directly
                setSelectedGroup('extreme');
                if (onFrameworkSelect) {
                    onFrameworkSelect('extreme-mode');
                }
                toast.success('Extreme mode activated - Academic search and advanced tools enabled');
                onChange('');
                setActiveInterface(null);
                break;
            case '/tools':
    ...
    const handleFrameworkSelect = (framework: StudyFramework) => {
        // Handle group selection directly based on framework
        if (framework === 'extreme-mode') {
            setSelectedGroup('extreme');
            toast.success('Extreme mode activated - Academic search and advanced tools enabled');
        } else {
            setSelectedGroup('extreme'); // Most study frameworks use extreme group for tools
    ...
    return (
        <div className="relative w-full">
            ...
            {activeInterface === 'frameworks' && (
                <FrameworkSelector onSelect={handleFrameworkSelect} onClose={closeInterface} />
            )}
