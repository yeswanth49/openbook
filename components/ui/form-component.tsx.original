...
const models = [
    { value: "neuman-default", label: "o4 mini", icon: OpenAIIcon, iconClass: "text-current", description: "OpenAI's faster mini reasoning model", color: "blue", vision: true, reasoning: true, experimental: false, category: "Stable" },
    ...
    { value: "neuman-google", label: "Gemini 2.5 Flash (Preview)", icon: GeminiIcon, iconClass: "text-current", description: "Google's advanced small reasoning model", color: "gemini", vision: true, reasoning: true, experimental: false, category: "Stable" },
    { value: "neuman-gemini", label: "Gemini 2.5 Pro (Preview)", icon: GeminiIcon, iconClass: "text-current", description: "Google's advanced  reasoning model", color: "gemini", vision: true, reasoning: true, experimental: false, category: "Stable" },
    { value: "neuman-4o", label: "GPT 4o", icon: OpenAIIcon, iconClass: "text-current", description: "OpenAI's flagship model", color: "blue", vision: true, reasoning: false, experimental: false, category: "Stable" },
    { value: "neuman-4.1-nano", label: "GPT 4.1-nano", icon: OpenAIIcon, iconClass: "text-current", description: "OpenAI's nano model", color: "blue", vision: true, reasoning: false, experimental: false, category: "Stable" },
    { value: "neuman-qwq", label: "QWQ 32B", icon: QwenIcon, iconClass: "text-current", description: "Alibaba's advanced reasoning model", color: "purple", vision: false, reasoning: true, experimental: true, category: "Experimental" },
];
                                        ...
                                        {typeof model.icon === 'string' ? (
                                            <img
                                                ...
                                                className={cn(
                                                    ...
                                                    model.iconClass,
                                                    model.value === "neuman-optimus" && "invert"
                                                )}
                                            />
                                        ) : (
                                            <model.icon
                                                    ...
                                                    <button
                                                        onClick={(e) => {
                                                            ...
                                                            const description = selectedGroup === 'extreme'
                                                                ...
                                                                : 'Enhanced deep reasoning mode is now active';

                                                            // Use appropriate colors for groups that don't conflict with model colors
                                                            showSwitchNotification(
                                                                newModeText,
                                                                description,
                                                                selectedGroup === 'extreme' ? <ChatCircle className="size-4" /> : <TelescopeIcon className="size-4" />,
